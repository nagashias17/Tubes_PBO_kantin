...
import newpackage.GUI_HomePelanggan;
...
public class GUI_pelanggan_login extends javax.swing.JFrame {
    ...
    List<Pelanggan_Kelompok_6> listPelanggan = new ArrayList<Pelanggan_Kelompok_6>();
    
    public GUI_pelanggan_login() {
        initComponents();
        listPelanggan = koneksiPelanggan.GetDataPelanggan();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      if (loginMasukpelanggan() == true) {
           GUI_HomePelanggan home = new GUI_HomePelanggan();
           home.show();
           dispose();
      } else {
    ...
    public boolean loginMasukpelanggan(){
        ...
        while (kondisi == false && index < listPelanggan.size()) {
            if (usernameTxt.getText().intern() == listPelanggan.get(index).getId_Pelanggan().intern() && passwordTxt.getText().intern() == listPelanggan.get(index).getPass_pelanggan().intern()) {
                kondisi = true;
            } else {
                kondisi = false;
            }
